...
Note: Scott domain is a bounded omega-algebraic cpo, and every algebraic cpo is continuous cpo. Therefore
the concept of continuous lattice is relevant in constructing semantics for untyped lambda calculus and other
recursive fields.
