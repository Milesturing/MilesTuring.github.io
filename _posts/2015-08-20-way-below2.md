...
U = {y}, due to the requirement of Scott openness for U. In the former case, we construct D = {(a, i) | i is any natural 
...
contradicts the condition that U is an open set.
